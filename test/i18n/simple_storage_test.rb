...
# def some_replace_command
#   index.each(search.dup, replacement.dup) do |call|
#     if I18n::Commands::Source.replace_key?(call, replacement) # user feedback about the source
#       translation = I18n.t(old_key) # have an exception handler that asks for a file if translation is missing
#       I18n.backend.store_translation(new_key, translation)
#       index.replace_key!(call, search, replacement)
#       I18n.backend.remove_translation(old_key) unless index.has_call?(old_key)
#       I18n.backend.save_translations
#     end
#   end
# end
